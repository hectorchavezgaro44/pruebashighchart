...
```{r}
secc <- st_read("~/Dropbox (Selva)/Ciencia de datos/Consultoría Estadística/Recursos/Externos/INE/SHP/2017/20 - Oaxaca/SECCION.shp", stringsAsFactors = FALSE, quiet = TRUE) %>%
  st_transform(4326) 


mun <- st_read("~/Dropbox (Selva)/Ciencia de datos/Consultoría Estadística/Recursos/Externos/INE/SHP/2017/20 - Oaxaca/MUNICIPIO.shp", stringsAsFactors = FALSE, quiet = TRUE) %>%
  st_transform(4326) 


hua_mun <- filter(mun, MUNICIPIO=="414")
secc <- filter(secc, MUNICIPIO=="414")
